...
The `Capture` class in the RABiTPy package is responsible for loading video files or image sequences and converting them into frames for further processing.
